...
import 'package:saas_mosque/features/room/data/repositories/room_repo_impl.dart';
...
Future<void> init() async {
  ...
  serviceLocater.registerLazySingleton<RoomRepo>(() {
    return RoomRepoImpl(serviceLocater());
  });
